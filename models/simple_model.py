...
if __name__ == "__main__":
    ...
    train_losses, test_losses = train_laptime_model(laptime_mlp, train_laptime_loader, val_laptime_loader, num_epochs=50)
    ...
    train_position_model(position_mlp, train_position_loader, val_position_loader, num_epochs=50)
